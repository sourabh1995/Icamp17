...
;( function( window ) {
	...
	FForm.prototype._nextField = function( backto ) {
		...
		this.isLastStep = this.current === this.fieldsCount - 8 && backto === undefined ? true : false;
		...
		var self = this,
			onEndAnimationFn = function( ev ) {
				...
				var stipend = document.getElementById("myRadio").value;
				...
				*/
				...
				if( self.isLastStep ) {
					...
					// classie.add( form1, 'fs-show' );
					
					var input_y_a = document.getElementById("stipend-y-1");
					var input_y_b = document.getElementById("stipend-y-2");
					var input_y_c = document.getElementById("stipend-y-3");
					
					var input_n_a = document.getElementById("stipend-n-1");
					
					var stipend = document.querySelector('input[name="q3"]:checked').value;
					
						if ( stipend == 'stipend-y') {
							
							classie.remove( input_y_a, 'fs-hidden' );
							classie.remove( input_y_b, 'fs-hidden' );
							classie.remove( input_y_c, 'fs-hidden' );
							
							classie.add( document.getElementById("without"), 'fs-hidden' );
							
						} else {	
						
							classie.remove( input_n_a, 'fs-hidden' );
							
							classie.add( document.getElementById("with"), 'fs-hidden' );
