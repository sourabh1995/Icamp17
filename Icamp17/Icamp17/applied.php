        ...
        <span class="icon-bar"></span>
           ...
           <div class="row">
              <footer id="admin-footer" class="clearfix">
                  ...
                  <div class="pull-left"><b>E-Cell 2017</b></div>
...
if(isset($_COOKIE['username'])&&isset($_COOKIE['password']))
{
$sql="SELECT student_applied.id,student_applied.Email,Applied1,startup.id,Name,website,startup.email,Stipend,Location,Description,Skills FROM `student_applied`,startup WHERE startup.Name=student_applied.Applied1";
       $result=$conn->query($sql);
       while($row=$result->fetch_assoc())
       {
       if($_COOKIE['username']==$row["Email"])
       {
 ...
 echo '<div class="modal fade" id="'.$row["id"].'" role="dialog">
                       ...
                       <form action="delete.php" method="post" id="apply12">
                                ...
                                <p><a href="'.$row["website"].'" target="_blank">'.$row['Name'].'</a></p>
                                    ...
                                    <div class="modal-footer">
                                      <input type="hidden"value="'.$row["Name"].'" id="'.$row["id"].'" name="company">
                                       <input type="submit" class="btn btn-success" value="Delete"name="apply">
