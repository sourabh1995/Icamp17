...
if(isset($_COOKIE['username'])&&isset($_COOKIE['password']))
{
$sql="SELECT student_bookmark.id,student_bookmark.Email,Bookmarked,startup.id,Name,website,startup.email,Stipend,Location,Description,Skills FROM `student_bookmark`,startup WHERE startup.Name=student_bookmark.Bookmarked";
